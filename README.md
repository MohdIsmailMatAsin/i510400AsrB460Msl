...
| DTGP      | original ACPI Method from actual Apple DSDTs which contain this logic to figure out what to return                                                                                                                                                                                                                                                                                            |
...
| PNLF      | Fake PNLF device for macOS to play with, specifically one with a hardware ID of APP0002. Most real Mac has this device. It is working or not. Not sure                                                                                                                                                                                                                                                                                                                                           |
