...
- 💠 [rusty-bits](https://github.com/rusty-bits) 😁 [cross platform](https://en.wikipedia.org/wiki/Cross-platformsoftware) OpenCore EFI update , known as [octool](https://github.com/rusty-bits/octool)
