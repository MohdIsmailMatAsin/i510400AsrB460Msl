...
| PNLF      | A fake PNLF device for macOS to play with, specifically one with a hardware ID of APP0002 (AppleIntelPanelA). Most real Macs have this. Is it working or not? Not sure.                                                                                                                                                                                                                                                                                                                                         |
