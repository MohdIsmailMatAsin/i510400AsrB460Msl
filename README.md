...
<p align="justify">The USBMap.kext version I use is the same as the one generated by USBTollbox.  The injection step is performed using Windows 11 with the native usb port function.  Plus, "XHCI-unsupported" injection is added to USBMap.kext info.plist since "8086A3AF" USB device is not supported by MacOS. Thi injection is compulsory to make this device works.</p>
